...
\sekt{modules}). This result origins from TODO cite Bartl and our proof follows
TODO cite Bartl.
...
following the philosophy of (TODO cite How to believe a formal proof)
...
(if you find the equality $0^{-1}\!=\!0$ disturbing, read TODO that explains it), and embeds rational numbers:
\begin{lstlisting}
...
define the dual program; the rest generates proofs that our six conditions stay satisfied
after dualization, where \texttt{aeply} is a custom tactic based on \texttt{aesop} TODO cite):
\begin{lstlisting}
...
TODO names like $A_0$ do not work well with the ``subscript notation'' on paper.
