...
\sekt{modules}). This result origins from TODO cite Bartl.
...
gives $c \* f$ as it should, converted to the type $F_\infty$
\end{itemize}
...
That is why multiplication between matrices and vectors is defined only in structures
