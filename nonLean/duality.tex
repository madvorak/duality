...
\end{itemize}
% https://link.springer.com/chapter/10.1007/11541868_15 ?

Sakaguchi \cite{Vass-Coq} proved a version of \ref{equalityFarkas}
for real field types in Rocq, using the Fourier-Motzkin elimination.
Allamigeon and Katz \cite{Simplex-Coq} made a large contribution to
the study of convex polyhedra in Rocq.
Among other results, they proved a version of \ref{equalityFarkas}
for real field types as well as the strong LP duality
in the asymmetric version \eqref{eq:StandardLP.strongDuality:assym}.
% I have no idea what "Boolean reflection" is.
...
% Also exists in Mizar: https://mizar.uwb.edu.pl/JFM/Vol5/hahnban.html
% Also in Rocq: https://www.ii.uib.no/~bezem/abstracts/TYPES_2019_paper_50
