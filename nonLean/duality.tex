...
duality theorems for reals and possibly for extended reals.
However, we would first need to prove that the set defined by linear
inequalities is closed, which is not for free. Moreover, we do not
know how to extend the result to other linearly ordered fields if obtained
using the Hahn-Banach separation theorem for reals.
