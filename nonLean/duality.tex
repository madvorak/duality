...
(Dantzig, von Neumann~\cite{Discussion}; Gale, Kuhn, Tucker~\cite{GaleKuhnTucker}).
...
\end{lstlisting}
The definition of optimum is, sadly, very complicated: {\color{blue} TODO this changed.}
\begin{lstlisting}
...
it is defined.
{\color{blue} TODO do not use $\restriction$ it is not idiomatic.}
