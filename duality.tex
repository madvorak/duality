...
The following linear program is a dual of itself:
$$
A =
\begin{pmatrix}
0
...
$$
For strong duality to hold, the only permissible optimum would be $0$.
The optimum of given program is $\top$ however.
...
c = \begin{pmatrix}	0 \end{pmatrix}
$$
If $A$ has $\bot$ in a column where $c$ has $\bot$, the following may happen:
$$
A =
\begin{pmatrix}
\bot & 1
